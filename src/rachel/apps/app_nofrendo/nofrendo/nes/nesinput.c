...
static uint8 get_zapper(void) { return (uint8)(retrieve_type(INP_ZAPPER)); }
...
static uint8 get_vsdips0(void) { return (retrieve_type(INP_VSDIPSW0)); }

static uint8 get_vsdips1(void) { return (retrieve_type(INP_VSDIPSW1)); }

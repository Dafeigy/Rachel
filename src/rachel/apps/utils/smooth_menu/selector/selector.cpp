...
namespace SMOOTH_MENU
{
    ...
    {
        /* Squeeze selector  */
        _anim_cntr.width.setAnim(_cfg.animPath_width,
                                 _anim_cntr.width.getValue(_anim_cntr.currentTime),
                                 _current_menu->getItemList()[_item_status.target]->width / 4 * 5,
                                 _cfg.animTime_width);
        _anim_cntr.height.setAnim(_cfg.animPath_height,
                                  _anim_cntr.height.getValue(_anim_cntr.currentTime),
                                  _current_menu->getItemList()[_item_status.target]->height / 4 * 3,
                                  _cfg.animTime_height);
    ...
    void Selector_t::released()
    {
        ...
        _anim_cntr.width.setAnim(_cfg.animPath_width,
                                 _anim_cntr.width.getValue(_anim_cntr.currentTime),
                                 _current_menu->getItemList()[_item_status.target]->width,
                                 _cfg.animTime_width);
        _anim_cntr.height.setAnim(_cfg.animPath_height,
                                  _anim_cntr.height.getValue(_anim_cntr.currentTime),
    ...
    void Selector_t::update(uint32_t currentTime, bool renderAtOnce)
    {
        ...
        if (_item_status.changed)
        {
            ...
            _anim_cntr.y.setAnim(_cfg.animPath_y,
                                 ...
                                 _cfg.animTime_y);
            _anim_cntr.width.setAnim(_cfg.animPath_width,
                                     _anim_cntr.width.getValue(currentTime),
                                     _current_menu->getItemList()[_item_status.target]->width,
                                     _cfg.animTime_width);
            _anim_cntr.height.setAnim(_cfg.animPath_height,
                                      _anim_cntr.height.getValue(currentTime),
                                      _current_menu->getItemList()[_item_status.target]->height,
                                      _cfg.animTime_height);
    ...
    void Selector_t::render(bool renderMenu)
    {
        ...
        {
            _render_callback->renderCallback(_anim_cntr.x.getValue(_anim_cntr.currentTime),
